...
public class NsgOperationAdapter extends RecyclerView.Adapter<NsgOperationAdapter.ViewHolder>{

    private List<NsgOperationRecyclerItems> listItems;
    private Context mContext;

    public NsgOperationAdapter(List<NsgOperationRecyclerItems> listItems, Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final NsgOperationRecyclerItems item = listItems.get(position);
