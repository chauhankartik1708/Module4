...
public class NsgHistoryActivity extends AppCompatActivity {
    private RecyclerView recyclerView;
    private NsgHistoryAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nsg_history);
        ...
        for(int i=0;i<history.length;i++){
            String a = dates[i];
            String b = history[i];
            listItems.add(new NsgHistoryRecyclerItems(a,b));
        }
        adapter = new NsgHistoryAdapter(listItems,this);
